        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Connections_AspNetUsers_GuestId",
                        column: x => x.GuestId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Connections_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceTableName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeColumnName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MinimumAccessLevel = table.Column<short>(type: "smallint", nullable: false),
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attributes_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Attributes_Resources_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attributes_OwnerId",
                table: "Attributes",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Attributes_ResourceId",
                table: "Attributes",
                column: "ResourceId");

            migrationBuilder.CreateIndex(
                name: "IX_Connections_GuestId",
                table: "Connections",
                column: "GuestId");
